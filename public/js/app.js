...
var paymentForm = document.querySelector('#paymentOnline');
...
if (paymentForm) {
  paymentForm.addEventListener('submit', function (e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().post('/orders', formObject).then(function (res) {//notification for order successful
      // setTimeout(() => {
