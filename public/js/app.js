...
var cartCounter = document.querySelector('#cartUpdateNumber');
...
var alrtmsg = document.querySelector('#alert');
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var stripe, payment, showPayment, card, paymentForm;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            showPayment = document.querySelector('#elementId');
            console.log(payment);
            card = null;
            ...
            paymentForm = document.querySelector('#paymentOnline');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkzomato"] = self["webpackChunkzomato"] || [];
